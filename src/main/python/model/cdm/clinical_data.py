...
class ConditionOccurrence(base):
    ...
    condition_source_value = Column(String(500))
...
class DrugExposure(base):
    ...
    visit_occurrence_id = Column(ForeignKey('public.visit_occurrence.visit_occurrence_id'), index=True)
    visit_detail_id = Column(ForeignKey('public.visit_detail.visit_detail_id'))
    drug_source_value = Column(String(500))
    drug_source_concept_id = Column(BigInteger, nullable=False)
    route_source_value = Column(String(500))
...
class Measurement(base):
    ...
    visit_occurrence_id = Column(ForeignKey('public.visit_occurrence.visit_occurrence_id'), index=True)
    visit_detail_id = Column(ForeignKey('public.visit_detail.visit_detail_id'))
    measurement_source_value = Column(String(500))
    measurement_source_concept_id = Column(BigInteger, nullable=False)
    unit_source_value = Column(String(500))
    value_source_value = Column(String(500))
...
class Observation(base):
    ...
    visit_occurrence_source_value = Column(String(500))
    visit_detail_id = Column(ForeignKey('public.visit_detail.visit_detail_id'))
    observation_source_value = Column(String(500))
    observation_source_concept_id = Column(BigInteger, nullable=False)
    unit_source_value = Column(String(500))
    qualifier_source_value = Column(String(500))
...
class Death(base):
    ...
    cause_source_value = Column(String(500))
...
class ProcedureOccurrence(base):
    ...
    visit_occurrence_id = Column(ForeignKey('public.visit_occurrence.visit_occurrence_id'), index=True)
    visit_detail_id = Column(ForeignKey('public.visit_detail.visit_detail_id'))
    procedure_source_value = Column(String(500))
    procedure_source_concept_id = Column(BigInteger, nullable=False)
    modifier_source_value = Column(String(500))
...
class VisitOccurrence(base):
    ...
    provider_id = Column(ForeignKey('public.provider.provider_id'))
    care_site_id = Column(ForeignKey('public.care_site.care_site_id'))
    visit_source_value = Column(String(500))
    ...
    record_source_value = Column(String(500))
...
class StemTable(base):
    ...
    lot_number = Column(String(50))
    route_source_value = Column(String(500))
    dose_unit_source_value = Column(String(500))
    condition_status_source_value = Column(String(500))
    ...
    specimen_source_id = Column(String(50))
    anatomic_site_source_value = Column(String(50))
    disease_status_source_value = Column(String(500))
...
class Episode(base):
    ...
    episode_source_value = Column(String(500))
